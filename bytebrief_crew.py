...
#     goal="Write a short 2-tweet engaging thread based on tech news summary",
...
#     goal="Save the tweet thread to Google Docs grouped by date",
#     backstory="You're the last step in ByteBrief — archive every thread properly so the team can review and post.",
...
# write_task = Task(
#     description="Write a 2-tweet Twitter thread based on the summarized trends. Start with a hook tweet and follow-up with value-add tweet(s).",
#     expected_output="A 2-tweet formatted thread for Twitter",
#     agent=thread_writer,
#     context=[summarize_task]
# )

# thread_save_to_docs = Task(
#     description="Save the tweet thread into Google Docs grouped by date with space between thread days",
#     expected_output="A URL of the Google Doc with threads neatly formatted",
